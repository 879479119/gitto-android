...
public abstract class OwnerProfileActivity extends HybridActivity implements OwnerDetailsView, AppBarLayout.OnOffsetChangedListener {
...
//    }
    ...
    protected LinearLayout getLayout() {
        return (LinearLayout) findViewById(R.id.user_hybrid);
    }
